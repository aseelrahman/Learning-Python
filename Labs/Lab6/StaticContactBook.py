# Create three contacts using a dictionary
new_contact1 = {
    'full_name': 'Tom Smith',
    'phone': '718-123-4567'
}
...
print()
'''
Remove phone key for second contact using the popitem which
removes the last key.
'''
new_contact2.popitem()

# Use the get method to avoid any errors for missing keys.
